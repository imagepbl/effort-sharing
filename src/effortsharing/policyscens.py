...
class policyscenadding:
    # =========================================================== #
    # =========================================================== #

    def __init__(self, startyear=2021, input_file="input.yml", xr_total=None):
        print("# ==================================== #")
    ...
    def read_engage_data(self):
        ...
        df_new = df_eng[
            ~df_eng.index.isin(
                np.where((df_eng.Scenario == "GP_CurPol_T45") & (df_eng.Model == "COFFEE 1.5"))[0]
            )
        ]
        self.df_eng = df_new
        ...
        df_eng_co2 = df_eng_co2[
            ~df_eng_co2.index.isin(
                np.where(
                    (df_eng_co2.Scenario == "GP_CurPol_T45") & (df_eng_co2.Model == "COFFEE 1.5")
                )[0]
            )
        ]
